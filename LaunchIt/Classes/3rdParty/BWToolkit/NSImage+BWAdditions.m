...
- (NSImage *)bwRotateImage90DegreesClockwise:(BOOL)clockwise
{
     ...
     */
    existingSize.width = [[(id)existingImage bestRepresentationForDevice:nil] pixelsWide];
    existingSize.height = [[(id)existingImage bestRepresentationForDevice:nil] pixelsHigh];
    ...
    [[(id)existingImage bestRepresentationForDevice:nil] drawInRect:r1];
